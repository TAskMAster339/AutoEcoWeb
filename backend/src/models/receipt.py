...
class Receipt(BaseModel):
    ...
    __table_args__ = (
        ...
        Index("ix_receipts_seller_id", "seller_id"),
        Index(
            "uq_receipts_user_qr",
            "user_id",
            "qr",
    ...
    qr: Mapped[str | None] = mapped_column(String(512), nullable=True)
    receipt_number: Mapped[str | None] = mapped_column(String(32), nullable=True)
    operation_type: Mapped[int] = mapped_column(SmallInteger, default=1, nullable=False)
    ...
    cashback: Mapped[Decimal | None] = mapped_column(Numeric(12, 2), nullable=True)
