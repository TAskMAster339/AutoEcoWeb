...
export function AboutPage() {
  ...
  return (
    <Stack spacing={2} sx={{ maxWidth: 760, mx: 'auto', width: '100%', pb: 2 }}>
      ...
      <Section icon={<VpnKeyOutlinedIcon sx={{ fontSize: 18 }} />} title="Ключ проверки чеков">
        <P>Данные чеков мы получаем через сервис проверки чеков — он запрашивает их напрямую из ФНС. Для автоматической загрузки чека по QR-коду нужен персональный ключ этого сервиса.</P>
        <Li>Получите ключ в личном кабинете сервиса проверки чеков (proverkacheka.com).</Li>
        <Li>Откройте «Профиль» → «Ключ сервиса проверки чеков» и вставьте его.</Li>
        <Li>Нажмите «Сохранить» — статус покажет «Ключ подключён».</Li>
        <P sx={{ mb: 0 }}>Ключ хранится только в вашем аккаунте и подставляется при сканировании QR-кода чека.</P>
      </Section>
