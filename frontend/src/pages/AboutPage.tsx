    ...
    return (
        <>
            <GuideSection title="Основные разделы">
                ...
                <Bullet><Link component={RouterLink} to="/dashboard" color="primary" underline="hover" fontWeight={700}>Чеки</Link> — исходные покупки, загруженные по QR-коду. Откройте чек, чтобы посмотреть реквизиты и позиции; при необходимости добавляйте чеки камерой или вручную через меню «Добавить».</Bullet>
