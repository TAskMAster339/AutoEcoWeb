            ...
            <Grid container spacing={2}>
                ...
                <Grid size={{ xs: 12, md: 7 }}>
                    <Card sx={{ p: 2.5, height: '100%', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} sx={{ alignItems: 'stretch', mt: 'auto', pt: 2 }}>
                            <PasswordField
                            ...
                            <Button
                                ...
                                sx={{ height: 40, whiteSpace: 'nowrap', px: 3, flexShrink: 0, width: { xs: '100%', sm: 'auto' } }}
                            >
                                Сохранить
                            </Button>
                        </Stack>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                    <Card sx={{ p: 2.5, height: '100%', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, alignItems: { xs: 'stretch', sm: 'center' }, justifyContent: 'flex-end', gap: 1.5, mt: 'auto', pt: 2 }}>
                            <Button
                                variant="contained"
                    ...
                    <Card sx={{ p: 2.5, borderColor: `${colors.red}55` }}>
                        ...
                        {confirming ? (
                            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5}>
                                <Button fullWidth variant="contained" color="error" onClick={handleLogout} disabled={busy}>
                                    {busy ? 'Выходим…' : 'Да, выйти'}
                                </Button>
                                <Button fullWidth variant="outlined" onClick={() => setConfirming(false)}>
                                    Отмена
                                </Button>
                            </Stack>
                        ) : (
